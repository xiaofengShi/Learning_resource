...
def train(**kwargs):
    ...
    loss_meter = meter.AverageValueMeter()  # 计算所有数的平均值和标准差,统计一个epoch的损失的平均值
    confusion_matrix = meter.ConfusionMeter(2)  # 计算混淆矩阵，用来统计分类问题中的分类情况，是一个比准确率更详细的统计指标
    previous_loss = 1e100
...
def val(model, dataloader):
    ...
    for ii, data in enumerate(dataloader):
        # for ii, data in tqdm(enumerate(dataloader)): # 原来的迭代方式
        input, label = data
