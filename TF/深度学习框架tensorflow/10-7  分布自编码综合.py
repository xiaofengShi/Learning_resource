# -*- coding: utf-8 -*-
"""
Created on Thu May 25 09:24:11 2017
...
with tf.Session() as sess:
    ...
    for epoch in range(epochs):
        ...
        saver.save(sess, savedir + 'stacked_auto_encoder.ckpt', global_step=epoch)
...
with tf.Session() as sess:
    ...
    saver.restore(sess, savedir +"stacked_auto_encoder.ckpt-" + str(load_epoch))
